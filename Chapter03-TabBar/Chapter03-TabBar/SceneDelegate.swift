    ...
    func scene(_ scene: UIScene, willConnectTo session: UISceneSession, options connectionOptions: UIScene.ConnectionOptions) {
        ...
        if let tbC = self.window?.rootViewController as? UITabBarController {
            if let tbItems = tbC.tabBar.items {
                ...
                let tbItemProxy = UITabBarItem.appearance() // 외형 프록시 객체
                ...
                let tbProxy = UITabBar.appearance() // 외형 프록시 객체
                tbProxy.tintColor = UIColor.white
                tbProxy.unselectedItemTintColor = UIColor.gray
           ...
           // tbC.tabBar.unselectedItemTintColor = .gray // backgroundimage 사용할 경우 stretchableImage 사용가능
