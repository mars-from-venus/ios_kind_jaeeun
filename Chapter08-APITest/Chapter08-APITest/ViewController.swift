...
class ViewController: UIViewController {
    ...
    @IBOutlet weak var IbI_Time: UILabel!
    ...
    @IBAction func btn_Time(_ sender: Any) {
        do {
            ...
            // 2. 읽어온 값을 레이블에 표시
            self.IbI_Time.text = response
            self.IbI_Time.sizeToFit()
